...
description: A crucial part of getting started with Celo is adding the network to your MetaMask wallet, which opens up a range of possibilities to interact with the platform. In this article, we provide a step-by-step tutorial on how to add the Celo network.
lesson: "0"
publishedAt: '2023-02-01'
image: https://docs.celo.org/assets/images/3-simple-steps-to-connect-your-metamask-wallet-to-celo-a1e0388154990c622cbfc7ef54d8da05.png
slug: 3-simple-steps-to-connect-your-metamask-wallet-to-celo
---

![header](https://docs.celo.org/assets/images/3-simple-steps-to-connect-your-metamask-wallet-to-celo-a1e0388154990c622cbfc7ef54d8da05.png)
